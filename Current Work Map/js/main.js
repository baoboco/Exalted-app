...
document.addEventListener('DOMContentLoaded', async () => {
  try {
    ...
    // 8. Activer la couche principale
    if (layerManager) {
...
/**
 * Fonction utilitaire pour charger des scripts de manière asynchrone
...
/**
 * Charge plusieurs scripts de manière asynchrone et parallèle
 * @param {Array<string>} scripts - Liste des URLs de scripts à charger
 * @returns {Promise} - Promesse résolue lorsque tous les scripts sont chargés
 */
