...
function chargerNiveauxPourFormulaire() {
    ...
    try {
        ...
        if (niveauxSauvegardes) {
            ...
            // Ajouter uniquement les niveaux qui sont dans CONFIG.carte.cheminNiveaux
            for (let i = 0; i < CONFIG.carte.cheminNiveaux.length; i++) {
                niveauxParDefaut.push({
                    ordre: i,
        ...
        // Ajouter niveau 1 si disponible
        if (CONFIG.carte.cheminNiveaux.length > 1) {
            niveauxSecours.push({ ordre: 1, nom: "Souterrains" });
        }
