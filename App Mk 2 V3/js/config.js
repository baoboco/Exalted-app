...
const CONFIG = {
    ...
    ressources: {
        icones: {
            ...
            dossierStructureBatiments: "assets/icons/Structure et batiments/",
            dossierPiege: "assets/icons/Piege/",
            dossierSymboles: "assets/icons/icone symbole/",
            dossierPersonnages: "assets/icons/corps et personnages/",
            dossierArmes: "assets/icons/Armes/",
            extension: ".svg",
            fallback: "assets/icons/Structure et batiments/house.svg", // Icône par défaut si celle demandée n'existe pas
            
            // Correspondance entre types de marqueurs et chemins d'icônes
            typeIcones: {
                'taverne': 'Structure et batiments/medieval-village-01',
                'temple': 'Structure et batiments/ancient-columns',
                'commerce': 'Structure et batiments/village',
                'residence': 'Structure et batiments/house',
                'danger': 'Piege/spikes-full',
                'secret': 'icone symbole/skull-crossed-bones',
                'bank': 'Structure et batiments/medieval-village-01',
                'clock-tower': 'Structure et batiments/clock-tower',
                'hospital': 'Structure et batiments/hospital',
                'maze': 'icone symbole/maze-cornea'
            }
        },
        cartes: {
